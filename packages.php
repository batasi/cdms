...
<div class="container-fluid">
    ...
    <?php 
        $package = $conn->query("SELECT * FROM `courses` where `status` = 1 order by `course` asc");
    ...
    <div class="text-decoration-none list-group-item rounded-0 package-item">
        ...
        <div class="collapse" id="package_<?= $row['id'] ?>">
            ...
            <div class="mx-3">
                <span class="mr-3 text-muted"><span class="fa fa-calendar"></span> <?= $row['training_duration'] ?>Days / 3-5 Weeks</span>
            </div>
