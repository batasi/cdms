...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-dark">
        <!-- Brand Logo -->
        <a href="..//../admin" class="brand-link bg-transparent text-sm shadow-sm">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="..//../admin/?page=fees" class="nav-link nav-fees">
                        <i class="nav-icon fas fa-book"></i>
                        <p>
                    <?php if($_settings->userdata('type') == 1 || $_settings->userdata('type') == 2): ?>Enrollment<?php endif;?>
                     <?php if (isset($_SESSION['userdata']['sname']) && isset($_SESSION['userdata']['id_no'])): ?>My Fees<?php endif?>                        
                        </p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="..//../admin/?page=payments" class="nav-link nav-payments">
                    ...
                    <li class="nav-item">
                      <a href="..//../admin/?page=enrollees" class="nav-link nav-enrollees">
                    ...
                    <li class="nav-item">
                      <a href="..//../admin/?page=students" class="nav-link nav-current-students">
                        <i class="nav-icon fas fa-users"></i>
                        <p>
                    ...
                    <li class="nav-item">
                      <a href="..//../admin/?page=alumina_students" class="nav-link nav-alumini-students">
                        <i class="nav-icon fas fa-users"></i>
                        <p>
                          Alumini Students
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="..//../admin/?page=packages" class="nav-link nav-packages">
                    ...
                    <li class="nav-item">
                        <a href="..//../admin?page=info" class="nav-link">
                    ...
                    <li class="nav-item dropdown">
                      <a href="..//../admin/?page=expenses" class="nav-link nav-expenses">
                        <i class="nav-icon fas fa-file"></i>
                        <p>
                          Expenditures
                        </p>
